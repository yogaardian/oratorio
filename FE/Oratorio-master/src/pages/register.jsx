      ...
      <div className="auth-container">
        ...
        <form className="auth-form">
          <div className="input-group">
            ...
            <input type="email" id="email" name="email" placeholder="Daftarkan email Anda" />
            <input type="password" id="password" name="password" placeholder="Daftarkan password Anda" />
          </div>
